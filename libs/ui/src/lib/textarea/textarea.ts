...
@Component({
  ...
  template: `
    ...
    >
      ...
      <button
        type="submit"
        class="inline-flex h-9 w-9 items-center justify-center rounded-none bg-[#2d7ff9] text-white transition-colors hover:bg-[#4690ff] disabled:cursor-not-allowed disabled:bg-[#2a3b5b] disabled:text-[#7f90a8]"
        [disabled]="!value().trim()"
